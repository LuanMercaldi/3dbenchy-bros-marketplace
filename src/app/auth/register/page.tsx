...
export default function RegisterPage() {
  ...
  const handleGithubRegister = () => {
    // TODO: Implementar registro com GitHub
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground font-mono">
              Crie sua conta e comece a explorar nossos produtos incríveis
            </p>
          </div>

          <Card variant="neon">
            <CardHeader>
              <CardTitle className="text-center">Nova Conta</CardTitle>
            </CardHeader>
            ...
            <CardContent>
                ...
                <div>
                  <label className="flex items-start space-x-2 cursor-pointer">
                    ...
                    <span className="text-sm font-mono text-muted-foreground">
                      Eu aceito os{' '}
                      <Link href="/terms" className="text-primary hover:text-neon transition-colors">
                        Termos de Uso
                      </Link>
                      {' '}e a{' '}
                      <Link href="/privacy" className="text-primary hover:text-neon transition-colors">
              ...
              <div className="text-center mt-6 pt-6 border-t border-border">
                <p className="text-sm font-mono text-muted-foreground">
                  Já tem uma conta?{' '}
                  <Link href="/auth/login" className="text-primary hover:text-neon transition-colors">
                    Fazer login
                  </Link>
                </p>
              </div>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-card border border-border image-pixelated">
              <div className="w-8 h-8 bg-accent mx-auto mb-2 flex items-center justify-center image-pixelated">
                <span className="text-sm">🏆</span>
              </div>
              <p className="text-xs font-mono text-muted-foreground">
                Programa de pontos
